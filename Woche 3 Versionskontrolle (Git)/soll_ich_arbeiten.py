...
def soll_ich_arbeiten():
    entscheidungen = [
<<<<<<< HEAD
        ("Ja, heute ist ein produktiver Tag!", "Wenn nicht, wird dein Kaffee morgen sehr stark sein!"),
=======
        ("Ja, heute ist ein produktiver Tag!", "Wenn nicht, gibts morgen dreifach soviel Kaffee!"),
>>>>>>> oehlemar
